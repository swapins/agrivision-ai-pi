...
| BME280 SDA/SCL | shared I2C bus |
| Pump MOSFET signal | GPIO17 |
| Green LED | GPIO22 through 220-330 ohm resistor |
| Yellow LED | GPIO23 through 220-330 ohm resistor |
| Red LED | GPIO24 through 220-330 ohm resistor |
...
Use a roughly 60 x 45 cm base. Put water and plants on one side and electronics on a raised dry platform on the other. Keep the reservoir below or beside the plant area, never above the Pi. Fix the camera distance and use a plain leaf-scan background for repeatability.
